      ...
      <div className="navbar">
        ...
        <div className="navbar-left">
          ...
          <div className="navbar-responsive">
            <div className="navbar-responsive-toggle">
            ...
            <ul className="navbar-responsive-item">
              ...
              <li>
                ...
                <div className="navbar-dropdown">
                  <ul>
                    {workspace.myWorkspace.map((ws, index) => (
                      <li key={index} className="navbar-dropdown-star-items">
                        <div>
                          <img src={ws.img} alt="img" />
                          <span>{ws.name}</span>
                        </div>
                    ...
                    <li className="navbar-dropdown-icon-items">
                      <div>
                        ...
                        <p>
                          ...
                          danh sách. Sử dụng bảng để quản lý các dự án, theo dõi
                          thông tin, hoặc tổ chức bất cứ việc gì.
                        </p>
                      </div>
                      <div>
                        <FaTable />
                    ...
                    <li className="navbar-dropdown-icon-items">
                      <div>
                        ...
                        <p>
                          ...
                          người. Sử dụng Không gian làm việc để tổ chức công ty
                          của bạn, hỗ trợ người bận rộn, gia đình hoặc bạn bè.
                        </p>
                      </div>
                      <div>
                        <FaUsers />
